...
/* **********************************
 * CrÈation et initialisation Produit
 ********************************** */
T_Produit *creerProduit(char *designation, float prix, int quantite) {
    ...
    if (nouveauProduit != NULL) {
        // l'allocation mÈmoire s'est bien passÈe
        nouveauProduit->designation = malloc(strlen(designation) + 1); // Important : malloc permet d'avoir l'espace mÈmoire dÈdiÈ pour notre champ de structure
...
/* ********************************
 * CrÈation et initialisation Rayon
 ******************************** */
...
/* **********************************
 * CrÈation et initialisation Magasin
 ********************************** */
...
/* **************************************************************************************
 * Recherche des produits se situant dans une fourchette de prix entrÈe par l'utilisateur
 ************************************************************************************** */
